...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    ...
    { Sid::timeMarkerFontFace,             "timeMarkerFontFace",                "Edwin" },
    { Sid::timeMarkerFontSize,             "timeMarkerFontSize",                10.0 },
    { Sid::timeMarkerLineSpacing,          "timeMarkerTextLineSpacing",         1.0 },
    { Sid::timeMarkerFontSpatiumDependent, "timeMarkerFontSpatiumDependent",    true },
    { Sid::timeMarkerFontStyle,            "timeMarkerFontStyle",               int(FontStyle::Normal) },
    { Sid::timeMarkerColor,                "timeMarkerTextColor",               PropertyValue::fromValue(Color::BLACK) },
    { Sid::timeMarkerAlign,                "timeMarkerAlign",                   Align(AlignH::LEFT, AlignV::BASELINE) },
    { Sid::timeMarkerOffsetType,           "timeMarkermOffsetType",             int(OffsetType::SPATIUM) },
    { Sid::timeMarkerPlacement,            "timeMarkerPlacement",               PlacementV::ABOVE },
    { Sid::timeMarkerPosAbove,             "timeMarkerPosAbove",                PointF(.0, -1.0) },
    { Sid::timeMarkerPosBelow,             "timeMarkerPosBelow",                PointF(.0, 2.5) },
    { Sid::timeMarkerMinDistance,          "timeMarkerMinDistance",             Spatium(0.5) },
    { Sid::timeMarkerFrameType,            "timeMarkerFrameType",               int(FrameType::NO_FRAME) },
    { Sid::timeMarkerFramePadding,         "timeMarkerFramePadding",            0.2 },
    { Sid::timeMarkerFrameWidth,           "timeMarkerFrameWidth",              0.1 },
    { Sid::timeMarkerFrameRound,           "timeMarkerFrameRound",              0 },
    { Sid::timeMarkerFrameFgColor,         "timeMarkerFrameFgColor",            PropertyValue::fromValue(Color::BLACK) },
    { Sid::timeMarkerFrameBgColor,         "timeMarkerFrameBgColor",            PropertyValue::fromValue(Color::transparent) },
