...
enum class Sid {
    ...
    timeMarkerFontFace,
    timeMarkerFontSize,
    timeMarkerLineSpacing,
    timeMarkerFontSpatiumDependent,
    timeMarkerFontStyle,
    timeMarkerColor,
    timeMarkerAlign,
    timeMarkerOffsetType,
    timeMarkerPlacement,
    timeMarkerPosAbove,
    timeMarkerPosBelow,
    timeMarkerMinDistance,
    timeMarkerFrameType,
    timeMarkerFramePadding,
    timeMarkerFrameWidth,
    timeMarkerFrameRound,
    timeMarkerFrameFgColor,
    timeMarkerFrameBgColor,
